...
\begin{document}
    ...
    \begin{enumerate}
        ...
        Para determinar si \cref{eq:psi_ket,eq:phi_ket} están normalizados, primero calculamos \(\bra{\psi}\) y \(\bra{\phi}\). Así,
